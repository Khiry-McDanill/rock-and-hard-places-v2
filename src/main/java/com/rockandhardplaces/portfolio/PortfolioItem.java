...
public class PortfolioItem {
 ...
 public String getMediaReference(){return mediaReference;} public void setMediaReference(String value){mediaReference=value;}
 ...
 public void updateExternal(String title, String description, LocalDate date) { if(isRhpVerified()) throw new SecurityException("RH&P history is platform-derived"); if(title==null||title.isBlank()) throw new IllegalArgumentException("Title is required"); this.title=title; this.description=description; this.completionDate=date; this.provenance=PortfolioProvenance.SELF_REPORTED; }
